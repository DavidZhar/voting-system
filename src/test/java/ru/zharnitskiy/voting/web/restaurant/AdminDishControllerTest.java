...
class AdminDishControllerTest extends AbstractControllerTest {
    ...
    void createDish() throws Exception {
        ResultActions action = mockMvc.perform(post("/rest/admin/restaurants/100002/dishes")
    ...
    void getDish() throws Exception {
        mockMvc.perform(get("/rest/admin/restaurants/100002/dishes/100004")
                .with(userHttpBasic(ADMIN)))
    ...
    void updateDish() throws Exception {
        mockMvc.perform(put("/rest/admin/restaurants/100002/dishes/100004")
                .with(userHttpBasic(ADMIN))
                .contentType(MediaType.APPLICATION_JSON)
        ...
        DISH_MATCHER.assertMatch(dishRepository.findById(100004).orElse(null), DISH_UPDATED);

    }

    @Test
    void deleteDish() throws Exception {
        mockMvc.perform(delete("/rest/admin/restaurants/100002/dishes/100004")
                .with(userHttpBasic(ADMIN)))
                .andDo(print());

        assertNull(dishRepository.findById(100004).orElse(null));
    }

    @Test
    void getAllByRestaurantAndDate() throws Exception {
        mockMvc.perform(get("/rest/admin/restaurants/100002/dishes?date=2020-01-01")
                .with(userHttpBasic(ADMIN)))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(result -> DISH_MATCHER.assertMatch(readListFromJsonMvcResult(result, Dish.class), dishRepository.findAllByRestaurantIdAndDate(100002, LocalDate.of(2020, 1, 1))));
    }
}