...
@Configuration
@EnableJpaRepositories(basePackages = "ru.zharnitskiy.voting.repository")
...
public class DBConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:hsqldb:mem:voting");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"ru.zharnitskiy.voting"});
